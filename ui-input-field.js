...
UiInputField.attributes.add('maxLength', { type: 'number', default: 5,//32 
    title: 'Max Length', 
    description: 'Maximum length of the text can be.' 
});
UiInputField.attributes.add('placeHolder', { type: 'string', default: '', //Placeholder text... 
...
UiInputField.attributes.add('placeHolderColor', { type: 'rgb', 
...
UiInputField.prototype._onValueChange = function (value) {
    ...
    if (value.length > 0) {
        ...
        this._textElement.color = new pc.Color(1, 0, 0, 1); //this.placeHolderColor
    }
