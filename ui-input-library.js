(function () {
    ...
    parent.document.documentElement.style.setProperty('--sat', 'env(safe-area-inset-top)');
    parent.document.documentElement.style.setProperty('--sab', 'env(safe-area-inset-bottom)');
    parent.document.documentElement.style.setProperty('--sal', 'env(safe-area-inset-left)');
    parent.document.documentElement.style.setProperty('--sar', 'env(safe-area-inset-right)');
    ...
    function resetStyle() {
        const leftSafeArea = parseInt(getComputedStyle(parent.document.documentElement).getPropertyValue("--sal"));
        const rightSafeArea = parseInt(getComputedStyle(parent.document.documentElement).getPropertyValue("--sar"));
